...
public class Favouurite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_favouurite);
    ...
    private void fetchFavoriteRecipes() {
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Favouurite.this, "Error loading favorite recipes", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
